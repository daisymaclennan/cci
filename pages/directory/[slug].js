  ...
  <Layout>
    ...
    <OrgDetailBox>
      <div className="website">
        ...
        <p className="text--website">{entry.website}</p>
      </div>
      ...
      <div className="phone">
        ...
        <p className="text--phone">{entry.phone_num}</p>
      </div>
      ...
      <div className="email">
        ...
        <p className="text--email">{entry.email_address}</p>
      </div>
      ...
      <div className="address">
        ...
        {entry.address && (
          <p className="text--address">{entry.address.concat(" ",entry.postcode)}</p>
        )}
      </div>
    </OrgDetailBox>
